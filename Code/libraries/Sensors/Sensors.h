...
class VisualSensor
{
  public:
     ...
     */
    VisualSensor(const char IRPort, const float stopVoltage, int center, byte errorDeadzone, unsigned long pixyUpdateTime,
    ...
    */
     ...
     */
    void isClose(unsigned long currentTime);
